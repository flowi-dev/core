...
UnionType.register(data => new UnionType(data.name, data.types.map(t => _Serializer.Serializer.deserialize(t))));
/**
...
ArrayType.register(data => new ArrayType(data.name, _Serializer.Serializer.deserialize(data.elementType)));
/**
...
AnyType.register(_ => new AnyType());
/**
...
ObjectType.register(data => new ObjectType(data.name, Object.fromEntries(Object.entries(data.properties).map(_ref2 => {
  let [key, value] = _ref2;
